...
extern NSString *_Nonnull
const UMPVersionString;
...
- (void)requestConsentInfoUpdateWithParameters:(nullable UMPRequestParameters
...
:
(
nonnull UMPConsentInformationUpdateCompletionHandler
)
handler;
