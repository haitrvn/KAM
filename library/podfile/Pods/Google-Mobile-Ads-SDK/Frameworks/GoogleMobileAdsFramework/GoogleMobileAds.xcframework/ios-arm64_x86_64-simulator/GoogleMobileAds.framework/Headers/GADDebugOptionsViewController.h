...
- (void)debugOptionsViewControllerDidDismiss:(nonnull GADDebugOptionsViewController
...
/// debug options.
+ (nonnull instancetype)debugOptionsViewControllerWithAdUnitID:(nonnull NSString
...
<GADDebugOptionsViewControllerDelegate> delegate;
