...
/// views.
FOUNDATION_EXPORT GADAdSize
GADPortraitInlineAdaptiveBannerAdSizeWithWidth(CGFloat
width);
...
/// views.
FOUNDATION_EXPORT GADAdSize
GADLandscapeInlineAdaptiveBannerAdSizeWithWidth(CGFloat
width);
...
FOUNDATION_EXPORT GADAdSize
GADCurrentOrientationInlineAdaptiveBannerAdSizeWithWidth(CGFloat
width);
...
FOUNDATION_EXPORT GADAdSize
GADInlineAdaptiveBannerAdSizeWithWidthAndMaxHeight(CGFloat
width,
CGFloat maxHeight
);
...
FOUNDATION_EXPORT GADAdSize
GADPortraitAnchoredAdaptiveBannerAdSizeWithWidth(CGFloat
width);
...
FOUNDATION_EXPORT GADAdSize
GADLandscapeAnchoredAdaptiveBannerAdSizeWithWidth(CGFloat
width);
...
/// This function must be called on the main queue.
FOUNDATION_EXPORT GADAdSize
GADCurrentOrientationAnchoredAdaptiveBannerAdSizeWithWidth(CGFloat
width);
...
GADAdSizeEqualToSize(GADAdSize
size1,
GADAdSize size2
);
...
_Nonnull NSStringFromGADAdSize(GADAdSize size);

/// Returns an NSValue representing the GADAdSize.
FOUNDATION_EXPORT NSValue
*

_Nonnull NSValueFromGADAdSize(GADAdSize size);

/// Returns a GADAdSize from an NSValue. Returns GADAdSizeInvalid if the value is not a GADAdSize.
FOUNDATION_EXPORT GADAdSize
GADAdSizeFromNSValue(NSValue
*
_Nonnull value
);
...
FOUNDATION_EXPORT GADAdSize
const kGADAdSizeSmartBannerPortrait
...
FOUNDATION_EXPORT GADAdSize
const kGADAdSizeSmartBannerLandscape
