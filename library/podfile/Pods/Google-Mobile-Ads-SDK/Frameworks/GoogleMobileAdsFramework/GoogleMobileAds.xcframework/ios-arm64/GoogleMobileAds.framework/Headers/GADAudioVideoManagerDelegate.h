...
- (void)audioVideoManagerWillPlayVideo:(nonnull GADAudioVideoManager

*)
audioVideoManager;

/// Tells the delegate that the Google Mobile Ads SDK has paused/stopped all video playback.
- (void)audioVideoManagerDidPauseAllVideo:(nonnull GADAudioVideoManager
...
- (void)audioVideoManagerWillPlayAudio:(nonnull GADAudioVideoManager
...
- (void)audioVideoManagerDidStopPlayingAudio:(nonnull GADAudioVideoManager
