...
(
_Nullable id
<GADMediationBannerAd> ad, NSError
*
_Nullable error
);
...
(
_Nullable id
<GADMediationInterscrollerAd> ad,
        NSError
*
_Nullable error
);
...
(
_Nullable id
<GADMediationNativeAd> ad, NSError
*
_Nullable error
);
...
+ (void)setUpWithConfiguration:(nonnull GADMediationServerConfiguration

*)
configuration
        completionHandler
:(
nonnull GADMediationAdapterSetUpCompletionBlock
)
completionHandler;
...
- (void)loadBannerForAdConfiguration:(nonnull GADMediationBannerAdConfiguration
...
:
(
nonnull GADMediationBannerLoadCompletionHandler
)
completionHandler;
...
- (void)loadInterstitialForAdConfiguration:
        (nonnull GADMediationInterstitialAdConfiguration
...
/// back completionHandler with the loaded ad, or it may call back with an error. This method is
/// called on the main thread, and completionHandler must be called back on the main thread.
- (void)loadNativeAdForAdConfiguration:(nonnull GADMediationNativeAdConfiguration
...
:
(
nonnull GADMediationNativeLoadCompletionHandler
)
completionHandler;
...
- (void)loadRewardedAdForAdConfiguration:
        (nonnull GADMediationRewardedAdConfiguration
...
- (void)loadAppOpenAdForAdConfiguration:
        (nonnull GADMediationAppOpenAdConfiguration
...
:
(
nonnull GADMediationAppOpenLoadCompletionHandler
)
completionHandler;
@end
